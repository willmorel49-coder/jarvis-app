...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      '.cat-insp-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:20px;border-bottom:1px solid var(--line);background:rgba(251,252,254,0.96);position:sticky;top:0}',
