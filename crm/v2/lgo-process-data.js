 ...
 "lgo": [
  ...
  },
  {
   ...
   "etapes": [
    ...
    "Indiquez les positions : colonne 1 = CIP 13 · 2 = libellé · 3 = prix remisé HT (prix net) · 4 = gamme. <b>Ne renseignez pas de remise</b> : le prix de la colonne 3 est déjà le prix net.",
    "Validez avec <b>F1</b> (trois fois)."
   ],
   "note": "Pour que les prix soient conservés, le laboratoire doit être affecté au fournisseur (onglet Achat de la fiche produit, ou onglet Catalogue de la fiche fournisseur).",
   "img": []
  },
  {
   "s": "pharmony",
  ...
  },
  {
   ...
   "etapes": [
    ...
    "Passez ensuite une commande périodique dans <b>Achats</b> : le catalogue se crée et les produits apparaissent dans « accords laboratoires »."
   ],
   "note": "",
   "img": []
  },
  {
   ...
   "note": "Si l'import échoue, c'est en général une question de colonnes : votre commercial vous aide à le refaire.",
   "img": []
  },
  {
   "s": "pharmavitale",
