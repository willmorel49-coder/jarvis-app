...
(function () {
  ...
  function injectCss() {
    ...
    st.textContent = [
      ...
      '.co-feed{display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border:1px solid var(--line);border-radius:var(--r-pill);background:var(--card);font-size:12px;font-weight:600;color:var(--muted-2)}',
      ...
      '.co-warnchip{display:inline-flex;align-items:center;gap:5px;font-size:12px;font-weight:700;color:var(--c-amber-txt,#9A5B12);background:#FBF1E2;border:1px solid #F0E2C6;padding:3px 9px;border-radius:var(--r-pill);width:max-content;max-width:100%}',
      ...
      '.co-lab{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:var(--muted)}',
      /* 25/09/2026 — WebKit ignore `min-height` sur un <select> natif (mesuré : 22px
         réels malgré la règle) alors que Chrome l'applique. `height` fixe marche dans
         les deux moteurs, vérifié sous Safari/WebKit réel (voir lot-6.md). */
      '.co-select{font:inherit;font-size:14px;font-weight:600;color:var(--ip-ink);background:var(--card);border:1px solid var(--line);border-radius:var(--r-btn,12px);padding:10px 12px;height:44px;max-width:100%;cursor:pointer}',
      ...
      '.co-visite-l{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);margin-right:2px}',
      ...
      '.co-visite-t small{color:var(--muted);font-weight:600;font-size:12px}',
      '.co-visite-int{border-color:color-mix(in srgb,#C2410C 30%,var(--line))}',
      '.co-visite-int .co-visite-t{color:#C2410C}',
      '.co-vbtn{border:1px solid var(--line-strong);background:var(--card);border-radius:8px;padding:5px 11px;font:inherit;font-size:12px;font-weight:700;color:var(--ip-ink);cursor:pointer;min-height:44px}',
      ...
      '.co-arg .t .psh{display:block;color:var(--muted);font-weight:700;font-size:12px;text-transform:uppercase;letter-spacing:.06em;margin-bottom:3px}',
      ...
      '.co-grow{display:inline-block;font-family:var(--mono);font-weight:800;font-size:12px;padding:1px 7px;border-radius:var(--r-pill,999px);margin-left:7px;vertical-align:middle;white-space:nowrap}',
      ...
      '.co-accel{display:inline-block;font-family:var(--mono);font-weight:800;font-size:12px;padding:1px 7px;border-radius:var(--r-pill,999px);margin-left:7px;vertical-align:middle;white-space:nowrap;color:#C2410C;background:#FFEDD5}',
      ...
      '.co-tb{font-size:12px;font-weight:800;letter-spacing:.01em;padding:3px 8px;border-radius:999px;white-space:nowrap;line-height:1.3}',
      ...
      '.co-spark-l{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:var(--muted-2,#9AA1B2)}',
      ...
      '.co-new{display:inline-block;font-family:var(--mono);font-weight:800;font-size:12px;text-transform:uppercase;letter-spacing:.04em;color:#7A3E00;background:#FFE9CC;padding:1px 7px;border-radius:var(--r-pill,999px);margin-left:7px;vertical-align:middle;white-space:nowrap}',
      ...
      '.co-ab{font-size:12px;font-weight:700;color:var(--c-mint-txt,#0F7A52);background:color-mix(in srgb,var(--c-opp) 12%,var(--card));padding:2px 8px;border-radius:var(--r-pill)}',
      ...
      '.co-mkt .id .c{font-family:var(--mono);font-size:12px;color:var(--muted-2);margin-top:1px}',
      ...
      '.co-mkt .m i{font-style:normal;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:var(--muted-2)}',
      ...
      '.co-fam{display:inline-block;font-size:12px;font-weight:700;color:var(--muted);background:var(--card-2);border:1px solid var(--line);padding:1px 7px;border-radius:var(--r-pill);vertical-align:middle;margin-left:6px}',
      ...
      '.co-tension{display:inline-flex;align-items:center;gap:4px;font-size:12px;font-weight:700;color:var(--c-amber-txt,#9A5B12);background:#FBF1E2;border:1px solid #F0E2C6;padding:1px 7px;border-radius:var(--r-pill);margin-left:6px;vertical-align:middle;white-space:nowrap}',
