...
(function () {
  ...
  function ensureEtab(cb) {
    ...
    var s = document.createElement('script'); s.src = 'etab-prices-data.js?v=20260702b1';
  ...
  function renderSite(root) {
    root.innerHTML = V2.topbar({ back: true, backTo: 'marketing', backLabel: 'Marketing' }) +
      '<div style="width:100%;height:calc(100vh - 66px);min-height:520px;background:#fff">' +
        '<iframe src="../../site-integral/index-typo.html?v=20260702b" title="Site vitrine Intégral Pharma" loading="lazy" style="width:100%;height:100%;border:0;display:block"></iframe>' +
      '</div>';
  }
  ...
  function renderPropositions(root) {
    root.innerHTML = V2.topbar({ back: true, backTo: 'marketing', backLabel: 'Marketing' }) +
      '<div style="width:100%;height:calc(100vh - 66px);min-height:520px;background:#FAFAF8">' +
        '<iframe src="../../site-integral/propositions/index.html?v=20260702b" title="Propositions de direction artistique" loading="lazy" style="width:100%;height:100%;border:0;display:block"></iframe>' +
      '</div>';
  }
  ...
  function renderFxBank(root) {
    root.innerHTML = V2.topbar({ back: true, backTo: 'marketing', backLabel: 'Marketing' }) +
      '<div style="width:100%;height:calc(100vh - 66px);min-height:520px;background:#06080F">' +
        '<iframe src="../../site-integral/fx-bank/index.html?v=20260702b" title="FX-BANK — banque d\'effets" loading="lazy" style="width:100%;height:100%;border:0;display:block"></iframe>' +
      '</div>';
  }
