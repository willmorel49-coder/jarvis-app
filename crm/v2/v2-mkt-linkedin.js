...
(function () {
  ...
  (function injectCss() {
    ...
    s.textContent = [
      /* ── tokens locaux (clair) ── */
      '#v2-root .li-wrap,#v2-root .lip .li-seg{--li-blue:var(--ip-blue);--li-blue600:#0047d6;--li-blue050:#eef3ff;--li-blue100:#dbe6ff;',
      ...
      /* .lip .li-seg : l'onglet est réutilisé par le rétro-planning, hors de .li-wrap */
      '#v2-root .li-wrap{max-width:1200px;margin:0 auto;padding:8px 22px 70px;color:var(--li-ink)}',
      ...
      '.li-today{height:34px;padding:0 14px;border-radius:9px;border:1px solid var(--li-line);background:var(--li-panel);font-family:inherit;font-size:13.5px;font-weight:600;line-height:1;color:var(--li-ink70);cursor:pointer;transition:all .15s var(--li-ease)}',
      ...
      '.li-segbadge{background:var(--li-orange);color:#fff;font-family:inherit;font-size:12px;font-weight:800;line-height:1;padding:2px 6px;border-radius:20px;min-width:16px;text-align:center}',

      /* ── buttons ── */
      '.li-btn{display:inline-flex;align-items:center;gap:7px;height:38px;padding:0 15px;border-radius:10px;border:1px solid var(--li-line);background:var(--li-panel);font-family:inherit;font-size:13.5px;font-weight:600;line-height:1;color:var(--li-ink70);cursor:pointer;transition:all .15s var(--li-ease)}',
      ...
      '.li-chip{display:inline-flex;align-items:center;gap:7px;height:30px;padding:0 12px;border-radius:20px;border:1px solid var(--li-line);background:var(--li-panel);font-family:inherit;font-size:12.5px;font-weight:600;line-height:1;color:var(--li-ink70);cursor:pointer;transition:all .15s var(--li-ease)}',
      '.li-chip:hover{border-color:#d3dae4}',
      '.li-chip .li-cdot{width:9px;height:9px;border-radius:50%;flex:none}',
      '.li-chip.li-off{opacity:.4}',
      '.li-statsel{height:30px;padding:0 30px 0 12px;border-radius:20px;border:1px solid var(--li-line);background:var(--li-panel);font-family:inherit;font-size:12.5px;font-weight:600;line-height:1;color:var(--li-ink70);cursor:pointer;-webkit-appearance:none;appearance:none;',
      ...
      '.li-wdname{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:var(--li-ink35)}',
      '.li-wtoday .li-wdname,.li-wtoday .li-wdnum{color:var(--li-blue)}',
      '.li-wdnum{font-size:14px;font-weight:700;color:var(--li-ink70)}',
      '.li-wpill{display:flex;align-items:center;gap:6px;width:100%;text-align:left;border-radius:8px;padding:6px 8px;margin-bottom:5px;border:0;border-left:3px solid var(--pc,#ccc);background:var(--pcbg,#f2f4f8);color:var(--li-ink);font-family:inherit;font-size:12px;font-weight:600;line-height:1.25;cursor:pointer;overflow:hidden;transition:transform .12s var(--li-ease),box-shadow .12s}',
      ...
      '.li-linkbtn{border:0;background:transparent;font-family:inherit;font-size:12.5px;font-weight:600;line-height:1;color:var(--li-ink50);cursor:pointer}',
      ...
      '.li-dd{font-size:12px;font-weight:600;color:var(--li-ink35);margin-top:1px}',
      ...
      '.li-ptag{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:700;padding:3px 9px 3px 8px;border-radius:20px}',
      '.li-ptag .li-cdot{width:8px;height:8px;border-radius:50%}',
      '.li-stag{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:600;color:var(--li-ink50);padding:3px 9px;border-radius:20px;background:#f1f4f8}',
      ...
      '.li-mini-primary{display:inline-flex;align-items:center;gap:7px;height:34px;padding:0 14px;border-radius:9px;border:0;background:var(--li-blue);color:#fff;font-family:inherit;font-size:13px;font-weight:700;line-height:1;cursor:pointer;box-shadow:0 3px 10px rgba(0,87,255,.24);transition:all .14s var(--li-ease)}',
      '.li-mini-primary:hover{background:var(--li-blue600);transform:translateY(-1px)}',
      '.li-mini-primary svg{width:15px;height:15px}',
      '.li-mini-link{border:0;background:transparent;font-family:inherit;font-size:12.5px;font-weight:600;line-height:1;color:var(--li-ink50);padding:5px 7px;border-radius:7px;cursor:pointer;transition:all .14s}',
      ...
      '.li-stat span{font-size:12px;color:var(--li-ink50);font-weight:600}',
      ...
      '.li-legnote{margin-top:12px;padding-top:12px;border-top:1px solid var(--li-line2);font-size:12px;color:var(--li-ink50);line-height:1.5}',
      ...
      '.li-weekhead div{padding:12px 14px;font-size:12px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;color:var(--li-ink35)}',
      ...
      '.li-cpill{display:flex;align-items:center;gap:6px;width:100%;text-align:left;padding:5px 7px;border-radius:8px;border:0;border-left:3px solid var(--pc,#ccc);background:var(--pcbg,#f2f4f8);color:var(--li-ink);font-family:inherit;font-size:12px;font-weight:600;line-height:1.2;cursor:pointer;overflow:hidden;transition:transform .12s var(--li-ease),box-shadow .12s}',
      ...
      '.li-more{border:0;background:transparent;font-family:inherit;font-size:12px;font-weight:600;line-height:1;color:var(--li-ink50);padding:2px 4px;text-align:left;cursor:pointer}',
      ...
      '.li-lgtitle{font-size:12px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;color:var(--li-ink35)}',
      ...
      '.li-colcount{font-size:12px;font-weight:700;color:var(--li-ink35);background:var(--li-panel);border:1px solid var(--li-line);border-radius:20px;min-width:20px;height:20px;padding:0 6px;display:flex;align-items:center;justify-content:center}',
      ...
      '.li-cpill2{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:700;padding:3px 9px;border-radius:20px}',
      ...
      '.li-cfoot{display:flex;align-items:center;gap:10px;font-size:12px;color:var(--li-ink50)}',
      '.li-cdate2{display:inline-flex;align-items:center;gap:5px}',
      '.li-cdate2 svg{opacity:.7}',
      '.li-pubcta{margin-top:10px;width:100%;border:1px solid var(--li-blue);color:var(--li-blue);background:var(--li-blue050);border-radius:9px;padding:7px;font-family:inherit;font-size:12px;font-weight:650;line-height:1;display:inline-flex;align-items:center;justify-content:center;gap:7px;cursor:pointer}',
      ...
      '.li-lrow-e{font-size:12px;background:#f1eafe;color:#7c56e6;border-radius:999px;padding:2px 9px;flex:none}',
      ...
      '.li-dr-eyebrow{font-size:12px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#0057FF;margin-bottom:8px}',
      ...
      '.li-gen{align-self:flex-start;display:inline-flex;align-items:center;gap:8px;height:36px;padding:0 14px;border-radius:10px;border:1.5px solid #0057FF;color:#0057FF;background:#eef3ff;font-family:inherit;font-size:13px;font-weight:700;line-height:1;cursor:pointer;transition:all .15s}',
      ...
      '.li-btn-ghost{background:#fff;border:1.5px solid #E6E9F0;color:#475569;height:36px;padding:0 14px;border-radius:10px;font-family:inherit;font-size:13px;font-weight:700;line-height:1;cursor:pointer}',
      ...
      '.li-pp{display:inline-flex;align-items:center;gap:8px;padding:8px 13px;border-radius:11px;border:1.5px solid #E6E9F0;background:#fff;font-family:inherit;font-size:12.5px;font-weight:600;line-height:1;color:#3a4152;cursor:pointer;transition:all .14s}',
      ...
      '.li-segstat button{flex:1;padding:8px 4px;border-radius:8px;border:0;background:transparent;font-family:inherit;font-size:12.5px;font-weight:600;line-height:1;color:#6b7280;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;transition:all .15s}',
      ...
      '#li-zoom .li-zcap{color:#fff;font-family:inherit;font-size:14px;font-weight:600;line-height:1.5;text-align:center;max-width:760px}',
      '#li-zoom .li-zdl{color:#cbd5e1;font-family:inherit;font-size:13px;font-weight:600;line-height:1;text-decoration:underline;text-underline-offset:3px}',
      ...
      '.li-del{border:0;background:transparent;font-family:inherit;font-size:13px;font-weight:600;line-height:1;color:#e0455f;padding:8px 10px;border-radius:8px;cursor:pointer}',
