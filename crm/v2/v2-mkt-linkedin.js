...
(function () {
  ...
  (function injectCss() {
    ...
    s.textContent = [
      ...
      '.li-segbadge{background:var(--li-orange);color:#fff;font-family:inherit;font-size:10px;font-weight:800;line-height:1;padding:2px 6px;border-radius:20px;min-width:16px;text-align:center}',
      ...
      '.li-wpill{display:flex;align-items:center;gap:6px;width:100%;text-align:left;border-radius:8px;padding:6px 8px;margin-bottom:5px;border:0;border-left:3px solid var(--pc,#ccc);background:var(--pcbg,#f2f4f8);color:var(--li-ink);font-family:inherit;font-size:11px;font-weight:600;line-height:1.25;cursor:pointer;overflow:hidden;transition:transform .12s var(--li-ease),box-shadow .12s}',
      ...
      '.li-more{border:0;background:transparent;font-family:inherit;font-size:11px;font-weight:600;line-height:1;color:var(--li-ink50);padding:2px 4px;text-align:left;cursor:pointer}',
