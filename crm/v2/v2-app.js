...
(function () {
  ...
  V2.render = function () {
    ...
    // instantanément au lieu d'un écran blanc figé. bridge() (dans loadFiles) peuple
    ...
    if (V2.loadFiles && !V2.dataLoaded('wml') && !V2._wmlAsked) {
      ...
      V2.loadFiles(['wml'])
        .then(function () { return V2.loadData ? V2.loadData() : null; })  // mappe WML → V2.pharmacies/V2.sales
