...
(function () {
  ...
  // ── RÉCONCILIATION WML (vérité client) : une seule règle pour toute l'appli, V2.reconcilePharma
  // (v2-app.js). Un client = officine dont l'id (p[13]) est dans WML_OFFICINES. Sinon → prospect.
  function reconcile() { if (V2.reconcilePharma) V2.reconcilePharma(); }
