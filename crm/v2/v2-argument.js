...
(function () {
  ...
  var CSS = [
    ...
    '.arg-regl label{display:block;font-size:12px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:var(--muted);margin:14px 0 4px}',
    ...
    '.arg-note{font-size:12px;color:var(--muted);border-top:1px solid var(--line);margin-top:14px;padding-top:10px}',
    ...
    '.arg-card .t{font-size:12px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:var(--muted)}',
    ...
    '.arg-preuve .s{font-size:12px;color:var(--muted-2);border-top:1px solid var(--line-2);margin-top:8px;padding-top:6px}',
