...
(function () {
  ...
  var COLOR_PRESETS = {
    ...
    'transformative-teal':  { name: 'Teal Vitalité',      category: 'trend',     mood: 'frais dynamique',       useCase: 'Nutrition · compléments · bien-être · minceur', bg:'#F8FAF9', accent:'#0F5A4E', headerBg:'#16A085', headerFg:'#FFFFFF', priceBg:'#0F5A4E', priceFg:'#FFE8A3', complementary:'#7AB8AC', highlight:'#FF6B35' },
    ...
    'mocha-mousse-2025':    { name: 'Mocha Apothicaire',  category: 'trend',     mood: 'chaleureux premium',    useCase: 'Phytothérapie · médecine douce · parapharma naturelle · BIO', bg:'#FAF5EC', accent:'#3A2A1F', headerBg:'#A47864', headerFg:'#FAF5EC', priceBg:'#3A2A1F', priceFg:'#F4B942', complementary:'#8B6F5C', highlight:'#5C8A4E' },
    'verdant-sage':         { name: 'Sage Botanique',     category: 'trend',     mood: 'frais sérieux',         useCase: 'Dermo-cosmétique sensibles · femmes enceintes · BIO', bg:'#F4F6F2', accent:'#2F4030', headerBg:'#7A9070', headerFg:'#F4F6F2', priceBg:'#2F4030', priceFg:'#FAF5EC', complementary:'#A8B89E', highlight:'#D4A574' },
    'coral-warmth':         { name: 'Corail Officinal',   category: 'trend',     mood: 'chaleureux dynamique',  useCase: 'Maternité-bébé · pédiatrie · anti-âge premières rides', bg:'#FDF8F4', accent:'#7A2E1A', headerBg:'#E07856', headerFg:'#FDF8F4', priceBg:'#7A2E1A', priceFg:'#FDF8F4', complementary:'#F2A88C', highlight:'#1E3A5F' },
    ...
    'ip-graphite-prestige': { name: 'IP Graphite Prestige', category: 'signature', mood: 'premium sérieux',     useCase: 'Grands comptes · groupements · centrales d’achat · présentations direction', bg:'#1A1D2E', accent:'#F2EDE4', headerBg:'#2C3045', headerFg:'#F2EDE4', priceBg:'#F2EDE4', priceFg:'#0A1F4E', complementary:'#0057FF', highlight:'#FFD66B' },
  };
