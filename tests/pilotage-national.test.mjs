...
if (existsSync(DONNEES)) {
  await import('./corps-pilotage-national.mjs');
} else {
  test('Pilotage national sur ventes reelles', { skip: 'ventes protegees (wml-ventes-NN.js) absentes du depot — joue ce test en local' }, () => {});
}
