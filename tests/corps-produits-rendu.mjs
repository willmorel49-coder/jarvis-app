...
// ⚠️ Le test « des references entrent bien en cours d annee » a disparu avec
// `nouveautesOfficine`, retiree le 24/08/2026 : elle n etait appelee nulle part
// dans l application. Ce qui reste teste ici, c est `suiviProposition` — la
// fonction jumelle, celle-la bien affichee par l ecran Produits.
