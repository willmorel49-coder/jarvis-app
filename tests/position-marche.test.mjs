...
if (existsSync(DONNEES)) {
  await import('./corps-position-marche.mjs');
} else {
  test('position marche sur ventes reelles', { skip: 'ventes protegees (wml-ventes-NN.js) absentes du depot — joue ce test en local' }, () => {});
}
