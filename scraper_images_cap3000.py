#!/usr/bin/env python3
"""
Scrape og:image depuis toutes les pages produit Cap3000.
Input  : benchmark_cap3000.xlsx
Output : images_cap3000.json  {ean: url, nom_norm: url}
"""
...
XLSX  = BASE / 'benchmark_cap3000.xlsx'
OUT   = BASE / 'images_cap3000.json'
DELAY = 0.35
...
wb.close()
hdr = rows[0]
col = {str(n).strip(): i for i, n in enumerate(hdr) if n}
